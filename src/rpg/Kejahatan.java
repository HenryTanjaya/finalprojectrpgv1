...
//        AnsiConsole.systemInstall();
        ...
        do {
            ...
            if (choose == 1) {
                ...
                System.out.println("byee" + RpgUtil.ANSI_RESET);
                RpgUtil.clearScreen();
                System.exit(0);
            }
        } while (ulang == 1);
        ...
        do {
            ...
            do {
                ...
                try {
                    ...
                    shop = n.nextInt();
                    if (shop < 1 || shop > 2) {
                        throw new IllegalArgumentException(colour.ANSI_BG_RED + colour.ANSI_WHITE + "Input 1-2");
                    }

                } catch (IllegalArgumentException e) {
                    System.out.println(e.getLocalizedMessage());
                } catch (InputMismatchException e) {
                    System.out.println(colour.ANSI_BG_RED + colour.ANSI_WHITE + "Pilih yang benar ya [1]-[2]");
                }
            } while (shop != 1 && shop != 2);

            if (hero.getGold() >= 500000 && shop == 1) {
    ...
    private static void about() {
        ...
        System.out.println(colour.ANSI_BG_WHITE + colour.ANSI_RED + "|==========================================|");
        System.out.println(colour.ANSI_BG_WHITE + colour.ANSI_RED + "|          Henry (26411)                   |");
        System.out.println(colour.ANSI_BG_WHITE + colour.ANSI_RED + "|          Albert (22803)                  |");
        System.out.println(colour.ANSI_BG_WHITE + colour.ANSI_RED + "|==========================================|");
